...
select a.id, a.username, a.1stname, a.lstname, a.password, a.note, a.officeid, b.username as office, a.status, a.registered, a.sites,
    max(c.intime) as lastlogintime, count(c.intime) as logintimes
...
union
select a.id, a.username, a.1stname, a.lstname, a.password, a.note, a.officeid, b.username as office, a.status, a.registered, a.sites,
    null as lastlogintime, 0 as logintimes
