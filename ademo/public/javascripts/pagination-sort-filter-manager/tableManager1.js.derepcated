...
(function ($) {
    /* Initialize function */
    $.fn.tablemanager1 = function (options = null) {
        /**
        ...
        if (options !== null) {
            ...
            **/
            if (pagination === true || Table.hasClass("tablePagination")) {
                ...
                var pagesDiv =
                    '<div id="pagesControllers1" class="pagesControllers1"></div>';
            ...
            **/
            if (
                ...
                Heads.each(function (col) {
                    if (
                        $(this).data("tablemanager1") &&
                        $(this).data("tablemanager1").dateFormat !== undefined
                    ) {
                        var dateF = $(this).data("tablemanager1").dateFormat;
                        dateColumn.push(col);
        ...
        **/
        Heads.each(function (n) {
            ...
            var disable =
                $(this).data("tablemanager1") === "disable"
                    ? true
        ...
        **/
        function generatePaginationValues() {
            ...
            $(".pagecontroller-num1").eq(0).addClass("currentPage");
        ...
        **/
        function appendPageControllers(nPages) {
            // reset div
            $("#pagesControllers1").html("");
            // First
            $("#pagesControllers1").append(
                $("<button>", {
                    value: "first",
                    text: "",
                    class: "pagecontroller1 pagecontroller-f",
                })
            );
            // Previous
            $("#pagesControllers1").append(
                $("<button>", {
                    value: "prev",
                    text: "",
                    class: "pagecontroller1 pagecontroller-p",
                })
            );
            // Numbers
            for (i = 1; i <= nPages; i++) {
                $("#pagesControllers1").append(
                    $("<button>", {
                        value: i,
                        text: i,
                        class: "pagecontroller1 pagecontroller-num",
                    })
                );
            }
            // Next
            $("#pagesControllers1").append(
                $("<button>", {
                    value: "next",
                    text: "",
                    class: "pagecontroller1 pagecontroller-n",
                })
            );
            // Last
            $("#pagesControllers1").append(
                $("<button>", {
                    value: "last",
                    text: "",
                    class: "pagecontroller1 pagecontroller-l",
                })
            );
        }
        ...
        **/
        function pagecontrollersClick() {
            $(".pagecontroller1").on("click", function () {
                ...
                $(".pagecontroller-num1").removeClass("currentPage");
                $(".pagecontroller-num1")
                    .eq(currentPage)
